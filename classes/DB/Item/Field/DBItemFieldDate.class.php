<?php
/**
 * DBItemFieldDate definition file
 */
 ...
 */
class DBItemFieldDate extends DBItemFieldNative{
	/**
	 * Format of the display.
	 * @var string
	 */
	public $displayFormat = "Y-m-d";
	
	/**
	 * Format of edit.
	 * @var string
	 */
	public $editFormat = "Y-m-d";
	...
	public function setValue(DBItem $item, $value){
		...
		elseif (!($value instanceof DateTime)){
			...
			$item->setRealValue($this->name, $value->format("Y-m-d"));
		}
	}
